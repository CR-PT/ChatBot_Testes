...
class TestObterResposta(unittest.TestCase):
    ...
    def teste_saude(self):
        ...
        self.assertEqual(obter_resposta("problemas saúde"), "A saúde é um estado de completo bem-estar físico, mental e social, e não apenas a ausência de doenças ou enfermidades.")  # mesma resposta
    ...
    def teste_resposta_padrao(self):
        ...
        texto_aleatorio2 = "coisa que não existe"
